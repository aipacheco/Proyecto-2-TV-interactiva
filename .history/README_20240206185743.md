...
- Extra: added a Netflix button that shows the Netflix intro and doesn´t allow you to change the channel up or down, but you can press any channel button to go to that channel
